...
alcohol aswell as residual sugar and density. As with Figure
...
your data into "purer" groups. Your data is initially a group of heterogenous
...
the authors, their package is a reimplementation of Brienman, Friedman, Olshen,
...
partitioning the data. The pruning step is to prevent overfitting. Pruning is
...
dtResults$fitted %>% plot(uniform = TRUE, main = "Decision Tree for Wine")
text(dtResults$fitted, all = TRUE, cex = 0.5)
```
