...
```{r fig.cap="Heatmap of variable correlations for the red wine data", fig.lp="red"}
red %>% select(-type) %>% cor %>% corrplot(order="hclust", type="lower")
```

```{r fig.cap="Heatmap of variable correlations for the white wine data", fig.lp="white"}
white %>% select(-type) %>% cor %>% corrplot(order="hclust", type="lower")
```

```{r fig.cap="Heatmap of variable correlations for the all wine data", fig.lp="wines"}
wines %>% select(-type) %>% cor %>% corrplot(order="hclust", type="lower")
```
